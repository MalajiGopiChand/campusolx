    ...
    <div className="infoPage">
      ...
      <div className="infoPageLayout">
        <div className="infoHero">
          <h1>Legal & Privacy</h1>
          <p>Terms of Service, Privacy Policy, and Cookie Policy for Campus OLX.</p>
        </div>
        ...
        <div id="terms" className="infoSection">
          ...
          <p>
            By using Campus OLX, you agree to these Terms of Service. Please read them
            carefully.
          </p>
          <h3>1. Use of the service</h3>
          <p>
            Campus OLX provides a platform for users to list, browse, and exchange
          ...
          <p>
            ...
            local laws. Campus OLX may remove content that violates our policies.
          </p>
          <h3>3. Transactions</h3>
          <p>
            Campus OLX is a venue for connecting buyers and sellers. We are not a party
          ...
          <p>
            The Campus OLX name, logo, and related marks are owned by Campus OLX Group. You
