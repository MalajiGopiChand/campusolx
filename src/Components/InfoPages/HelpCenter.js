    ...
    questions: [
      {
        ...
        a: 'Open the listing and use the "Chat" or "Contact" button to send a message. Always communicate through the Campus OLX app or website for your safety.',
      },
      {
    ...
    questions: [
      {
        ...
        a: 'Click "Sell" in the header, choose a category, add photos and details, set your price, and publish. You can edit or delete the ad from My Campus OLX.',
      },
      {
