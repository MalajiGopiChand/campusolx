    ...
    <div className="infoPage">
      ...
      <div className="infoPageLayout">
        <div className="infoHero">
          <h1>Campus OLX People</h1>
          <p>
            Meet the people behind Campus OLX — the team and culture that make our
        ...
        <div className="infoSection">
          ...
          <p>
            ...
            markets, focused on growing Campus OLX in a responsible and sustainable
            way.
          </p>
