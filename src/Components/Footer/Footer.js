    ...
    <div className="footerParentDiv">
      <div className="footerContent">
        <div className="footerContentInner">
          ...
          <div className="footerColumn">
            ...
            <ul className="footerList">
              <li>
                <Link to="/about">About Campus OLX Group</Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/people">Campus OLX People</Link>
              </li>
              <li>
          ...
          <div className="footerColumn">
            <h3 className="footerHeading">Campus OLX</h3>
            <ul className="footerList">
              <li>
      ...
      <div className="footerBottom">
        <div className="footerBottomInner">
          ...
          <p>Free Classifieds in India. © 2006-2021 Campus OLX</p>
        </div>
      </div>
    </div>
  );
